...
<head>
  ...
  <title>Login | POINT MARKER HALTE BUS BERBASIS WEBGIS
PADA PEMKO BANJARMASIN </title>
  ...
  <div class="login-box">
    ...
    <div class="card">
      <div class="login-logo">
        <br>
        <h4 style="color:blue; font-family:Impact, Charcoal, sans-serif">POINT MARKER HALTE BUS BERBASIS WEBGIS
PEMKO BANJARMASIN <br></h4>
        <h3>
          <img src="<?= base_url() ?>/assets/dist/img/bus-halte.png" style="margin-top: 20px; margin-bottom: 20px;" width="227px;" height="220px;">

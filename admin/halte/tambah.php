...
<body class="hold-transition sidebar-mini layout-fixed">
                                ...
                                <div class="card card-dark">
                                    ...
                                    <div class="card-body" style="background-color: white;">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control"  name="kd_halte">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="nama_halte" class="col-sm-2 col-form-label">Nama Halte</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="nama_halte" name="nama_halte">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="longInput" name="lng">
                                            </div>
                                        </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $submit = $koneksi->query("INSERT INTO halte VALUES (
            NULL,
            '$kd_halte',
            '$nama_halte',
            '$alamat',
...
<script>
  var mymap = L.map('mapid').setView([-3.316694 , 114.590111], 15);
